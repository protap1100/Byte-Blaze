...
const Author = () => {
    ...
    const {name,username,github_username,profile_image} = blog.user
        ...
        <div className="flex flex-col justify-center  p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
            ...
            <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                ...
                <div className="flex justify-center pt-2 space-x-4 align-center">
                    <a target="blank" rel="noopener noreferrer" href={`https://github.com/${github_username}`} aria-label="GitHub" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
